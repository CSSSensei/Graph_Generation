...
UI::UI(int argc, char *argv[], QApplication& app)
    ...
    imageLabel_->setMaximumSize(1600, 900);
    imageLabel_->setMinimumSize(1080, 900);
    ...
    probability_of_edge_->setStyleSheet("color: white;");
    ...
    button_generate_graph_->setStyleSheet("color: white;");
    ...
    button_add_vertex_->setStyleSheet("color: white;");
    ...
    button_add_edge_->setStyleSheet("color: white;");
    ...
    remove_vertex_->setStyleSheet("color: white;");
    ...
    button_coloring_graph_->setStyleSheet("color: white;");
...
void UI::addVertex() {
    ...
    graphRenderer_->render(graph_->get_desc_string(is_graph_directed_), "file1.png");
